...
{
    public static BlacklistedIpViewModel GetViewModel(this BlacklistedIpAddress model) => new()
    {
        Id = model.Id,
    ...
    public static BlacklistedIpAddress GetModel(this BlacklistedIpViewModel viewModel) => new()
    {
        Id = viewModel.Id,
